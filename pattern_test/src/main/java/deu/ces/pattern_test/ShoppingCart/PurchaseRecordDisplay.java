 ...
 * @author gka
 */
public class PurchaseRecordDisplay implements Observer, DisplayElement {
    ...
    public PurchaseRecordDisplay(ShoppingData shoppingData) {
    ...
    @Override
    public void display() {
        System.out.println("구매자 : " + customerID
                + "님\n브랜드 : " + brandName
                + "\n제품 이름 : " + productName
                + "\n구매 개수 : " + productQuantity
                + "\n개당 가격 : " + productPrice);

        // swing 사용
        JFrame cartFrame = new JFrame();
        cartFrame.setTitle("구매 내역 조회");
